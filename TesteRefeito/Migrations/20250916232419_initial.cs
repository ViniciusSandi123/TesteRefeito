    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmeGenero", x => new { x.FilmesId, x.GeneroId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilmeGenero_Generos_GeneroId",
                        column: x => x.GeneroId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmeStreaming", x => new { x.FilmesId, x.StreamingId });
                    table.ForeignKey(
                        name: "FK_FilmeStreaming_Filmes_FilmesId",
                        column: x => x.FilmesId,
                        principalTable: "Filmes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilmeStreaming_Streamings_StreamingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilmeStreaming_StreamingId",
                table: "FilmeStreaming",
                column: "StreamingId");
        }
